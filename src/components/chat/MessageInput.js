  ...
  return (
    <div className="p-2 sm:p-4 border-t bg-white">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        ...
        <button
          type="submit"
          className="bg-blue-500 text-white px-4 sm:px-6 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 text-sm sm:text-base"
