              ...
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    ...
                    alt="logo"
                    className="ml-10 max-w-full dark:hidden"
                  />
                  <img
                    src="https://cdn.tailgrids.com/2.0/image/assets/images/logo/logo-white.svg"
                    alt="logo"
                    className="ml-10 max-w-full hidden dark:block"
                  />
                </a>
                <p className="ml-10 mb-7 text-base text-body-color dark:text-dark-6">
                  Sed ut perspiciatis undmnis is iste natus error sit amet
                  voluptatem totam rem aperiam.
                </p>
                <p className="ml-10 flex items-center text-sm font-medium text-dark dark:text-white">
